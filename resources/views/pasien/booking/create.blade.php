                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if($psychologist->jadwals->count() > 0)
                        ...
                        <form method="POST" action="{{ route('pasien.booking.store') }}">
                            ...
                            <!-- Schedule Time -->
                            <div class="mb-4">
                                <label for="schedule_time" class="block text-sm font-medium text-gray-700">Waktu *</label>
                                ...
                                @error('schedule_time')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-sm text-gray-500 mt-1">Pastikan waktu sesuai dengan jadwal tersedia di atas</p>
                            </div>
