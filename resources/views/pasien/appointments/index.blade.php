                                ...
                                <div class="border rounded-lg p-4 hover:shadow-md transition">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-600">{{ $appointment->psikolog->psychologistProfile->specialization }}</p>
                                            
                                            <div class="mt-2 text-sm">
                                                <p><strong>Tanggal:</strong> {{ $appointment->schedule_date->format('d M Y') }}</p>
                                                <p><strong>Waktu:</strong> {{ \Carbon\Carbon::parse($appointment->schedule_time)->format('H:i') }}</p>
                                            </div>
