                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nomor STR</th>
                                    ...
                                    @foreach($unverifiedPsychologists as $profile)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <form method="POST" action="{{ route('admin.psychologists.verify', $profile->id) }}" class="inline">
                                                    @csrf
